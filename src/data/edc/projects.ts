...
const baseProjects: Array<Omit<Project, 'visitStages' | 'visitInterval'>> = [
  ...
  },
  {
    ...
    pi: '李教授',
    collabs: ['赵医生（上海市眼病防治中心）', '钱医生（广东中山医院）'],
    crcs: ['孙同学', '周同学'],
    sponsor: '南通诺瞳奕目医疗科技有限公司',
  ...
  },
  {
    ...
    pi: '陈主任',
    collabs: ['冯医生（上海市眼病防治中心）', '褚医生（苏州大学附属儿童医院）'],
    crcs: ['卫同学', '蒋同学'],
  ...
  },
  {
    ...
    pi: '周教授',
    collabs: ['沈医生（南京市第一医院）', '韩医生（上海市眼病防治中心）'],
    crcs: ['杨同学', '朱同学', '秦同学'],
  ...
  },
  {
    ...
    pi: '孙主任',
    collabs: ['何医生（复旦大学附属眼耳鼻喉科医院）', '吕医生（上海市眼病防治中心）', '施医生（上海市眼病防治中心）'],
    crcs: ['张同学', '孔同学', '曹同学'],
    sponsor: '上海儿童视觉健康研究院',
  ...
  },
  {
    ...
    pi: '唐博士',
    collabs: ['金医生（北京同仁医院）', '魏医生（上海市眼病防治中心）', '陶医生（广东中山医院）'],
    crcs: ['姜同学', '谢同学', '范同学'],
  ...
  },
  {
    ...
    pi: '顾主任',
    collabs: ['方医生（浙江大学医学院附属第二医院）', '俞医生（上海市眼病防治中心）'],
    crcs: ['任同学', '袁同学'],
    sponsor: '杭州瞳研科技有限公司',
  ...
  },
  {
    ...
    pi: '刘教授',
    collabs: ['欧医生（广东中山医院）', '解医生（深圳市眼科医院）'],
    crcs: ['邓同学', '崔同学'],
